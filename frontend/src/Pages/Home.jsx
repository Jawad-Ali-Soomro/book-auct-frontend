  ...
  return (
    <div className="home-page">
      ...
      <div className="main-books flex">
        {
          data.map((item) => {
            return <div className="main-book flex col">
            <img
              src={item.poster}
              alt=""
            />
      ...
      <div className="footer flex col" style={{gap:'10px'}}>
        <h3>BOOK-AUCT</h3>
        <h2>Where words become treasures, and pages find new homes. Happy bidding in the world of literary adventures!</h2>
        <div className="links flex">
          <a href=""><i className="uil uil-facebook"></i></a>
          <a href=""><i className="uil uil-twitter"></i></a>
          <a href=""><i className="uil uil-github"></i></a>
